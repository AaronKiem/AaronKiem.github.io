...
| pH electrode probe | Able to accurately detect H+ ion concentration to microcontroller to nearest whole number | Sends pH data to microcontroller to relay to user to nearest tenth digit | NO |
